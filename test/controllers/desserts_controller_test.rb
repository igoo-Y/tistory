...
class DessertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dessert" do
    assert_difference('Dessert.count') do
      post desserts_url, params: { dessert: { content: @dessert.content, status: @dessert.status, title: @dessert.title } }
    end
  ...
  test "should update dessert" do
    patch dessert_url(@dessert), params: { dessert: { content: @dessert.content, status: @dessert.status, title: @dessert.title } }
